...
import Loader from "../../compoents/loder/loder"
...
function Order() {
  ...
  return (
    ...
    {order.length > 0 ?
                ...
                <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
                  {
                    order.cartItem.map((item) => {
                      // const {title, imageUrl, descripetion, price} = item
                      return (
                          ...
                          <div className="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
                            ...
                            <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                              <div className="mt-5 sm:mt-0">
                                ...
                                <p className="mt-1 text-xs text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>{item.descripetion}</p>
      ...
      :
      (
        <h2 className=' text-center tex-2xl to-black'>Not Order found</h2>
      )
